/*
page 163
5.9 Write a program which reads the social security number 
SSS of an employee and prints the employee’s record. Test 
the program using (a) 165-64-3351, (b) 136-46-6262 and (c) 177-44-5555.
*/
#include<iostream>
#include<string>
#include<cctype>
