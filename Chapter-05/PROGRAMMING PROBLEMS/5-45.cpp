/*
Page 163
5.10 Write a program which reads an integer K and prints the name 
of each male employee when K = 1 or of each female employee when 
K = 2. Test the program using (a) K = 2, (b) K = 5 and (c) K = 1.
*/
#include<iostream>
#include<string>
#include<cctype>
