/*
Page 163
5.12 Write a program which reads the record of a new employee 
and inserts the record into the file. Test the program using 
(a) Fletcher 168-52-3388 Female 21000; and 
...
void DISPLAY_BY_GENDER(NODE *START, string SEX);
void DELETE_BY_NAME(NODE ** HEAD, string key);
/********************************************/
...
void START()
{
    ...
    while(1)
    {
        ...
        case '6':
            ...
            cin >> temp;
            DELETE_BY_NAME(&HEAD, temp);
            break;
        case '7':
            cout << "Enter 1 Print Male employee\n";
            cout << "Enter 2 Print Female employee\n";
            cin >> NUM;
            if(NUM == 1)
            {
                DISPLAY_BY_GENDER(HEAD, "Male");
            }
            else
            DISPLAY_BY_GENDER(HEAD, "Female");
            break;
        case '9':
            exit(0);
            break;
...
****************************************************************************************************
->      1
Fletcher 168-52-3388 Female 21000
$$$$$
