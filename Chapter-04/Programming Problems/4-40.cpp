...
4.10 Write a program which reads the NAME of a student and finds 
and prints the location and section number of the student. Test 
the program using 
(a) Harris, 
(b) Rivers and 
(c) Lopez.
...
void FIND(STUDENT section[],string Name, int SN)
{
   string *NNN;
   int CHECK = 1;
   for(int i = 0 ; i < SN; i++)
