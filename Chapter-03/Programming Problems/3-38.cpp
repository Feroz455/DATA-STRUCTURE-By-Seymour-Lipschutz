...
Page 66
Program
 Write a program which defines a linear array PAR such that PAR[K] 
 contains the location of the Kth paragraph, and which also defines 
 a variable NPAR which contains the number of paragraphs.
*/
#include<iostream>
#include<string>
using namespace std;
