/*
page 272/
7.32 Consider the binary search tree T in Fig. 7.101. 
Describe the final changes in INFO, LEFT, RIGHT, ROOT and 
AVAIL if the six operations in Problem 7.13 are applied one 
after the other (not independently) to T.
