...
void Print_By_gender(TreeNode *root, string sex)
{
    if(root!= NULL)
    {
        if(root->SEX == sex)
        ...
        Print_By_gender(root->left,sex);
        Print_By_gender(root->right,sex);
...
int main()
{
    ...
    in_order(root);
    cout << "\n\n";
    cout << "Enter 1 to Print male Employee\n 2 to Print Female employee\n";
    cin >> n;
    if(n == 1)
    {
        Print_By_gender(root, "Male");
    }
    else 
    Print_By_gender(root, "Female");
...
Enter 1 to Print male Employee
 2 to Print Female employee
1
     Kelly    165-64-3351      Male     19000
     Green    175-56-2251      Male     27200
