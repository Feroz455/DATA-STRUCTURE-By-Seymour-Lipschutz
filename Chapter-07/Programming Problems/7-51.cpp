/*
page 276
 7.51 Write a program which reads the name NNN of an employee and deletes 
the employee’s record from the structure. Test the program using 
(a) Davis, (b) Jones and (c) Rubin.
*/
#include<iomanip>
#include<iostream>
using namespace std;
...
int main()
{
    ...
    in_order(root);
    root = Delete(root, "Davis");
    root = Delete(root, "Jones");
    root = Delete(root, "Rubin");
    cout<<"\n\n" << setw(10) << "Name" << setw(15) << "SSN" << setw(10) << "SEX" << setw(10) << "SALARY" << endl;
    in_order(root);
    return 0;
}
/*
